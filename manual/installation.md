...
- Run `dotnet tool install simple-acme ‑‑global` as a priviledged user to install the program
- Run `dotnet tool update simple-acme ‑‑global` as a priviledged user to upgrade to the latest version
